...
if (!target || target.startsWith('--')) { console.error('Usage: npm run verify:free-activity -- --target <clean-baseline-repo>'); process.exit(2); }
...
for (const moduleId of ['core-integration', 'free-activity-mcp']) {
