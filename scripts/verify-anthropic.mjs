...
if (!target || target.startsWith('--')) { console.error('Usage: npm run verify:anthropic -- --target <clean-baseline-repo>'); process.exit(2); }
...
for (const moduleId of ['core-integration', 'anthropic-api-cache']) {
